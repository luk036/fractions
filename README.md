...
- Replace all occurrences of "Fractions" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Fractions` means the name of the project, while `fractions` is used in file names.
  - Remember to rename the `include/fractions` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
